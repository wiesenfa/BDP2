...
This involves the BDP2 package which is installed from \url{https://github.com/wiesenfa/BDP2}. The package is included in the submitted folder. The package contains the function plotBDP2 for plotting various figures. 

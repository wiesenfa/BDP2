...
Selected was $c_E$ = `r cE`. This leads to a type I error of `r round(res$y.p0[which.min(abs(res$x.p0-cE))[1]],2)` at $p_0$=`r p0`,
and a power of `r round(res$y.p1[which.min(abs(res$x.p1-cE))[1]],2)` at $p_1$=`r p1`.
